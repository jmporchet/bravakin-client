  ...
  componentWillMount () {
    ...
    fetch(myRequest)
      ...
      this.commentsAndLikes = [
        ...
        {date: new Date(Date.now() - (3 * 3600000)), likes: 0, followers: 2, comments: 5},
        ...
        {date: new Date(Date.now() - (6 * 3600000)), likes: 0, followers: 2, comments: 5},
        {date: new Date(Date.now() - (7 * 3600000)), likes: 40, followers: 2, comments: 5},
        {date: new Date(Date.now() - (8 * 3600000)), likes: 1, followers: 2, comments: 5},
        {date: new Date(Date.now() - (9 * 3600000)), likes: 12, followers: 2, comments: 5},
        {date: new Date(Date.now() - (10 * 3600000)), likes: 1, followers: 2, comments: 5},
        {date: new Date(Date.now() - (11 * 3600000)), likes: 5, followers: 2, comments: 5},
        {date: new Date(Date.now() - (12 * 3600000)), likes: 1, followers: 2, comments: 5},
        {date: new Date(Date.now() - (13 * 3600000)), likes: 13, followers: 2, comments: 5},
        {date: new Date(Date.now() - (14 * 3600000)), likes: 1, followers: 22, comments: 5},
        {date: new Date(Date.now() - (15 * 3600000)), likes: 22, followers: 2, comments: 5},
        {date: new Date(Date.now() - (16 * 3600000)), likes: 41, followers: 2, comments: 5},
        {date: new Date(Date.now() - (17 * 3600000)), likes: 38, followers: 2, comments: 5},
        {date: new Date(Date.now() - (19 * 3600000)), likes: 33, followers: 2, comments: 5},
        {date: new Date(Date.now() - (19 * 3600000)), likes: 16, followers: 2, comments: 5},
        {date: new Date(Date.now() - (20 * 3600000)), likes: 20, followers: 2, comments: 5}
      ];
  }
